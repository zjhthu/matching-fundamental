...
def savepkl(data_to_dump, dump_file_full_name):
    with open(dump_file_full_name, 'wb') as out_file:
        pickle.dump(data_to_dump, out_file)


def loadpkl(dump_file_full_name):
    with open(dump_file_full_name, 'rb') as in_file:
